...
def process_document(input_path: Path, output_path: Path):
    ...
    ensure_empty_between_heading1_and_heading2(doc, body_start)
    ensure_compact_heading2_spacing(doc, body_start)
    ensure_empty_before_table_caption(doc, body_start)
    remove_extra_empty_after_service_lines(doc, body_start)
    ensure_empty_after_source_and_note(doc, body_start)
    cleanup_reference_subheadings_layout(doc, body_start)
    collapse_empty_paragraphs_in_body(doc.paragraphs, body_start)
    format_empty_paragraphs_in_body(doc, body_start)
    normalize_structural_heading_spacing_v2(doc, body_start)
