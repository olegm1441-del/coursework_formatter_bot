    ...
    if balance > 0:
        if is_new:
            return (
                ...
                "Продолжая использование бота, вы соглашаетесь на обработку персональных данных в соответствии с Политикой обработки данных: https://docs.google.com/document/d/14Sk5N1ow-x30Dh2dLqYQtUU5-LbdUlemkTleL-THJDc/edit?usp=sharing. Отправляя документ, вы подтверждаете,что являетесь его автором и имеете право передавать его для обработки."
            )
        return (
            "С возвращением!\n"
            f"Сейчас доступно оформлений: {balance}\n"
