...
Внимательно пройдись по курсовой, чтобы убедиться:
- в конце страниц не висят без продолжения названия параграфов и таблиц
- в первой строке страниц не пустота
- если есть перенос таблицы, в начале второй страницы важно добавлять «Продолжение таблицы X.Y.Z»

P.S. в конце страницы пустыми можно оставить не более 3 строк

P.S.S Пригласи друга — получи ещё 1 бесплатное оформление""",
            )
        )
